...
<div  class="hidden2">
	<a class="card card-hover overflow-hidden flex flex-col h-full" target="_blank" href={art.url}>
		<header>
			<img loading="lazy" src={art.urlToImage ? art.urlToImage : "https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg"} class="bg-black/50 w-full aspect-[21/9]" alt={art.title} />
		</header>
